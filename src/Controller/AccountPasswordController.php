    ...
    public function index(Request $request, UserPasswordHasherInterface $encoder): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            if ($encoder->isPasswordValid($user, $old_pwd)){
                ...
                $notification = "votre password a correctement été mis a jour";
                $this->addFlash('success', 'votre password a correctement été mis a jour');

            } else {
                $notification = "votre password actuelle n'est pas le bon";
            }
        }
